...
#define AX_CCW_CW_LENGTH            7//8 ->changed by Rakesh Shrestha
...
public:
	...
	int setPositionControl(int ID);//added by Rakesh Shrestha
	...
	int readCWLimit(unsigned char ID);//added by Rakesh Shrestha
	int readCCWLimit(unsigned char ID);//added by Rakesh Shrestha
	int readSpeed(unsigned char ID);
	int readLoad(unsigned char ID);
