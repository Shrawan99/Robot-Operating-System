#ifndef _ROS_cob_relayboard_EmergencyStopState_h
#define _ROS_cob_relayboard_EmergencyStopState_h
...
namespace cob_relayboard
{
  ...
  class EmergencyStopState : public ros::Msg
  {
    ...
    const char * getType(){ return "cob_relayboard/EmergencyStopState"; };
